...
function ShowHideDivMapping()
{
	...
	if(off==true && on==false)
	{
		ShowHideDiv('mapping_info_bigDiv','config_file_bigDiv');
		progressBarContinue()
		progressBarContinue()
		progressBarContinue()
		progressBarContinue()
...
function ShowHideDivConfig()
{
   ...
   if(YesNo=="yes")
   {
		ShowHideDiv('config_file_bigDiv','mapping_processes_bigDiv');
		progressBarBack();
   }
   else
   {
		ShowHideDiv('config_file_bigDiv','mapping_info_bigDiv');
		progressBarBack();
		progressBarBack();
		progressBarBack();
		progressBarBack();
